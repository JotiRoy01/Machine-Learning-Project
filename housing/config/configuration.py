...
DataTransformationConfig , ModelEvaluationConfig, ModelTrainerConfig, ModelPusherConfig, TrainingPipelineConfig
...
class Configuration :
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            time_stamp = f"{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}"
